...
<body>
    ...
    <main class="container">
        <div class="row">
            <div class="col-md-3">
                <!-- ========== Start FORM ========== -->
                <form class="was-validated" action="insert/registro_habitat.php" method="post">
                    <br>
                    <div class="form-floating mb-3">
                        <input name="nombre_habitat" type="text" placeholder="name@example.com" class="form-control"
                            id="input_habitat" required>
                        <label for="input_habitat" class="form-label">Nombre del habitat</label>
                    </div>
