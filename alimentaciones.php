...
<body>
    ...
    <main class="container">
        <div class="row">
            <div class="col-md-3">
                <!-- ========== Start FORM ========== -->
                <form class="was-validated" action="insert/registro_alimentacion.php" method="post">
                    <br>
                    <div class="form-floating mb-3">
                        <input name="tipo_alimento" type="text" placeholder="name@example.com" class="form-control"
                            id="input_alimentacion" required>
                    ...
                    <tbody>
                        ...
                        while ($fila = mysqli_fetch_array($resultado)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="delete/eliminar_alimentacion.php?id_alimentacion=<?php echo $fila['id_alimentacion'] ?>">
                                        <i class="bi bi-trash2-fill text-danger" style="font-size: 1.5rem;"></i>
                                    </a>
                                </td>
                                <td>
                                    <a
                                        href="update/alimentacion.php?id_alimentacion=<?php echo $fila['id_alimentacion'] ?>">
